...
function addLayer(text = "Write here") {
  layers.push({
    text,
    x: canvas.width / 2,
    y: canvas.height / 2,
...
addTextBtn.addEventListener("click", () => addLayer("Type here"));
